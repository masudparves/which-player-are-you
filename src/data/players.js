...
export const PLAYERS = [
  { id: "haaland", name: "Erling Haaland", archetype: "machine", nickname: "The Goal Machine", rarity: "RARE", image: imgHaaland,
  ...
  { id: "kane", name: "Harry Kane", archetype: "machine", nickname: "The Goal Machine", rarity: "COMMON", image: imgKane,
    description: "Reliable, disciplined and calm. People trust you because you consistently deliver when it matters most." },
  { id: "musiala", name: "Jamal Musiala", archetype: "magician", nickname: "The Magician", rarity: "RARE", image: imgMusiala,
  ...
  { id: "wirtz", name: "Florian Wirtz", archetype: "magician", nickname: "The Magician", rarity: "RARE", image: imgWirtz,
    description: "You are intelligent, adaptable and quietly brilliant. You do not need attention to influence the game." },
  { id: "bellingham", name: "Jude Bellingham", archetype: "general", nickname: "The General", rarity: "EPIC", image: imgBellingham,
    description: "Natural leader. Even when nobody officially puts you in charge, people instinctively follow your direction." },
  { id: "debruyne", name: "Kevin De Bruyne", archetype: "general", nickname: "The General", rarity: "EPIC", image: imgDeBruyne,
    description: "You think three steps ahead. Strategic, analytical and efficient, you prefer smart solutions over flashy ones." },
  { id: "rodri", name: "Rodri", archetype: "general", nickname: "The General", rarity: "COMMON", image: imgRodri,
    description: "Calm under pressure. While others panic, you stay composed and quietly take control." },
  { id: "mbappe", name: "Kylian Mbappe", archetype: "speed", nickname: "The Cheetah", rarity: "LEGENDARY", image: imgMbappe,
    description: "Bold, ambitious and fearless. You thrive when moving fast and taking opportunities before others react." },
  { id: "saka", name: "Bukayo Saka", archetype: "speed", nickname: "The Speed Demon", rarity: "RARE", image: imgSaka,
    description: "Positive, energetic and dependable. People enjoy having you around because you bring enthusiasm everywhere." },
  { id: "hakimi", name: "Achraf Hakimi", archetype: "speed", nickname: "The Flash With Ball", rarity: "COMMON", image: imgHakimi,
    description: "Always moving forward. Adventurous, spontaneous and rarely afraid to take risks." },
  { id: "yamal", name: "Lamine Yamal", archetype: "showman", nickname: "The Showman", rarity: "EPIC", image: imgYamal,
    description: "Confident, expressive and entertaining. You love creating memorable moments." },
  { id: "vinicius", name: "Vinicius Jr", archetype: "showman", nickname: "The True Showman", rarity: "EPIC", image: imgVinicius,
    description: "Life is meant to be experienced. You bring excitement and energy wherever you go." },
  { id: "neymar", name: "Neymar Jr", archetype: "talisman", nickname: "The Talisman", rarity: "EPIC", image: imgNeymar,
    description: "Charismatic and influential. People pay attention when you walk into a room." },
  { id: "salah", name: "Mohamed Salah", archetype: "talisman", nickname: "The Talisman", rarity: "RARE", image: imgSalah,
    description: "Humble, hardworking and inspiring. You lead through actions, not words." },
];

// ---------- 5 SECRET LEGENDS (secret code only) ----------
export const LEGENDS = [
  { id: "messi", name: "Lionel Messi", archetype: "legend", nickname: "The GOAT", rarity: "LEGENDARY", image: imgMessi, code: "MAGICIANMMP", revealable: true,
  ...
  { id: "ronaldo", name: "Cristiano Ronaldo", archetype: "legend", nickname: "The Talisman", rarity: "LEGENDARY", image: imgRonaldo, code: "TALISMANMMP", revealable: true,
  ...
  { id: "zidane", name: "Zinedine Zidane", archetype: "legend", nickname: "Zizou", rarity: "LEGENDARY", image: imgZidane, code: "MAESTROMMP", revealable: true,
    description: "Elegant and composed. You make difficult things look effortless.", isLegend: true },
  { id: "pele", name: "Pele", archetype: "legend", nickname: "The King", rarity: "LEGENDARY", image: imgPele, code: "KINGMMP2026", revealable: false,
    description: "Your influence extends beyond your achievements. You inspire future generations.", isLegend: true },
  { id: "maradona", name: "Diego Maradona", archetype: "legend", nickname: "El Diego", rarity: "LEGENDARY", image: imgMaradona, code: "GODFATHERMMP2026", revealable: false,
